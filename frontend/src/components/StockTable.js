...
const StockTable = () => {
    ...
    return (
        <div className='cmp-stockcontainer'>
            <h2>
                Latest Stock Data for <span className="cmp-stockcontainer__symbol">{stock.data.symbol}</span> with <span className="cmp-stockcontainer__timeinterval">{stock.data.metaData.interval}</span> interval
            </h2>
